! function(e) {
	function t(t) {
		for (var o, a, u = t[0], c = t[1], f = t[2], p = 0, s = []; p < u.length; p++) a = u[p], r[a] && s.push(r[a][0]), r[a] =
			0;
				...
				return j(t, c["a"]), n = t, (o = [{
					...
					value: function() {
						d(w(t.prototype), "addLine", this).call(this, {
							...
							position: new i.Vector3(1.5 * (Math.random() - .5), Math.random() - 1, 2 * (Math.random() - .5)).multiplyScalar(
								Object(f.a)(5, 20)),
